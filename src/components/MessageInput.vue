...
import { AttachOutline, HappyOutline, SendOutline } from '@vicons/ionicons5'
</script>
    ...
    <NFlex class="flex flex-row p-10px b-t-#EFEFF5 b-t-solid b-t-1px w-full" :size="0" >
        <NFlex>
            <NButton :bordered="false" circle size="medium" ghost color="#898989">
                <template #icon>
                    <NIcon :size="25"><AttachOutline/></NIcon>
                </template>
            </NButton>
        </NFlex>
        <NFlex>
            <NButton :bordered="false" circle size="medium" ghost color="#898989">
                <template #icon>
                    <NIcon :size="25"><HappyOutline/></NIcon>
                </template>
            </NButton>
        </NFlex>
        <NFlex class="flex-1 m-l-10px m-r-10px">
            <NInput :bordered="false" round placeholder="Type your message here.." class="bg-#FAFAFA">
                <template #suffix>
                    <NIcon/>
                </template>
            </NInput>
        ...
        <NFlex>
            <NButton :bordered="false" circle size="medium" ghost color="#007AFF">
                <template #icon>
                    <NIcon :size="25"><SendOutline/></NIcon>
                </template>
            </NButton>
        </NFlex>
    </NFlex>
